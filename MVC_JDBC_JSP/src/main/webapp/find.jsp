...
Enter EmpId : <input type="text" name="findid"><br><br>
		...
		<form class="mx-auto" action="MainServlets" method="get">
			...
			<div class="mb-1 mt-1">
				<label for="exampleInputEmail1" class="form-label">Enter
					EmpID</label> <input type="text" name="findid" class="form-control"
					id="InputEmail" aria-describedby="emailHelp">
				<p id="on"></p>
			</div>
			

			<button type="submit" class="btn btn-primary mt-4" value="find" name="button">Find</button>
		</form>
	</div>
