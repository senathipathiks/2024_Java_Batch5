...
<body>
	<div class="container-fluid">
		<form class="mx-auto" action="Fetch2" method="post"
			modelAttribute="bean">
			<h1>Find by ID</h1>
			<select class="form-select" name="FlightName" aria-label="Select ID">
			...
			<button type="submit" class="btn btn-primary mt-4" value="Fetch2"
				...
				<div class="mb-1 mt-1">
					...
					<div class="mb-1">
						<label  class="form-label">Flight
							...
							value=${f.getFlightName() } required readonly>
