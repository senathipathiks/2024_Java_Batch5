...
<body>
	<div class="container-fluid">
		<form class="mx-auto" action="Fetch" method="post"
			modelAttribute="bean">
			<h1>update Flight Detail by using FlightID</h1>
			...
			<button type="submit" class="btn btn-primary mt-4" value="Fetch"
			...
			<form action="Updation" method="post" modelAttribute="bean">
				...
				<div class="mb-1 mt-1">
					<label class="form-label"> Flight Id</label> <input type="text"
						name="flightId" class="form-control" placeholder="ID"
						aria-describedby="emailHelp" value=${f.getFlightId() } readonly>

					<div class="mb-1">
						<label class="form-label">Flight Name</label> <input type="text"
							name="flightName" class="form-control"
							value=${f.getFlightName() } required>

					</div>
					<div class="mb-1">
						<label class="form-label">Source </label> <input type="text"
							name="source" class="form-control" value=${f.getSource() }
							required>
