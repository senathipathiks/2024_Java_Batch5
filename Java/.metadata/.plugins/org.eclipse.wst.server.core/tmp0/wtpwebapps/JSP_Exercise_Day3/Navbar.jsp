...
<nav class="navbar navbar-expand-lg bg-transparent">
  <div class="container-fluid">
    <a style="color:white" class="navbar-brand" href="Welcome.jsp">Employee Management System</a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        <a style="color:white"  class="nav-link active" aria-current="page" href="Buttons.jsp">Dashboard</a>
