...
<script>
function check(){
	var id = document.forms["Fform"]["id"].value;
	if(id === "" || id === " " || id === null){
...
<body>
<form action="LmsController" name="Fform" onsubmit="return check();" class="container" method="post">
<h1 align="center" class="display-4">Find Employees</h1>
<hr>
