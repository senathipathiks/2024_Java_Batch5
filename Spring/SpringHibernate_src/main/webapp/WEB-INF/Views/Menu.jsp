    ...
    <ul>
      <li>
        <button>
          ...
          <a href="Insert" target="frame3">Insert</a>
        </button>
      </li>
      <li>
        <button>
          ...
          <a href="Update" target="frame3">Update</a>
        </button>
      </li>
      <li>
        <button>
          ...
          <a href="ViewAll" target="frame3">View All</a>
        </button>
      </li>
      <li>
        <button>
          ...
          <a href="Find" target="frame3">Find Member</a>
        </button>
      </li>
      <li>
        <button>
          ...
          <a href="Delete" target="frame3">Delete</a>
        </button>
      </li>
      <li>
        <button>
          ...
          <a href="FetchBatch" target="frame3">Find By Batch</a>
        </button>
      </li>
    </ul>
  </nav>
