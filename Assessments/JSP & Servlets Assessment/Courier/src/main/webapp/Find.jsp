...
<script>
function check(){
	var id = document.forms["Fform"]["uid"].value;
	if(id === "" || id === " " || id === null){
...
<body>
<form action="CmsController" name="Fform" onsubmit="return check();" class="container" method="post">
<h1 align="center" class="display-4">Find Courier Details</h1>
<hr>
