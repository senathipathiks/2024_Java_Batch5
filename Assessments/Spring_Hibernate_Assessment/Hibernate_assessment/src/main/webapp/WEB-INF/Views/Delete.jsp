...
<h1 class="display-1">Delete Tender Details by ID</h1>
...
if(result.equals("Success")){
	 out.print("<h3><font color=green>Deleted Successfully!</font></h3>");
}
else{
	 out.print("<h3><font color=red>Deletion Failed!!!</font></h3>");
}
