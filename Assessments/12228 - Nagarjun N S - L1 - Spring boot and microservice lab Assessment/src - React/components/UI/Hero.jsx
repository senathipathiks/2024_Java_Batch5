            ...
            <div className='relative'>
                <header>
                    ...
                    <nav className={`pb-15 md:text-sm ${state ? "absolute top-0 inset-x-0 bg-white shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-0 md:mt-0 md:relative md:bg-transparent" : ""}`}>
                        <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-5">
                            <Brand />
                ...
                <section>
                    <div className="max-w-screen-xl mx-auto px-6 py-5 gap-24 text-gray-600 overflow-hidden md:px-9 md:flex">
