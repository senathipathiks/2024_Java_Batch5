...
body {
	 background-image:
		url('https://images.pexels.com/photos/260689/pexels-photo-260689.jpeg?auto=compress&cs=tinysrgb&w=600');
...
<center>
 ...
 <form action="SearchingName" method="post">
		<h1>Find User Details</h1>
		<select name="meetUserName">
			<option selected>Select Name</option>
			<c:forEach items="${NameList}" var="meetUserName">
				<option value="${meetUserName}">${meetUserName}</option>
			</c:forEach>
		</select> <br>
<!-- 		<input type="Submit" value="Find" name="button">
 -->	
 <button class="btn-53" type="Submit" value="FindName" name="button">
