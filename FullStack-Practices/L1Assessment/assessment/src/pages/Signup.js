        ...
        <main className="w-full flex">
            ...
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    <img src="https://cdn4.iconfinder.com/data/icons/modern-material-flat-basic-and-universal/64/Coffee-64.png" width={150} />
                    <div className=" mt-16 space-y-3">
                        <h3 className="text-white text-3xl font-bold">Start Drinking and Do Nothing</h3>
                        <p className="text-gray-300">
                            Happy Customers and their Reviews
                        </p>
                ...
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        ...
                        <div className="mt-5 space-y-2">
                            ...
                            <p className="">Already have an account? <a href="/signin" className="font-medium text-indigo-600 hover:text-indigo-500">Log in</a></p>
                        </div>
                    </div>
