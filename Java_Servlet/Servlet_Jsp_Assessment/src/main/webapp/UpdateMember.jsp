...
<body>
	...
	<form id="accesspanel" action="Controller" method="get" name="memberform" onsubmit="return validateForm()">
	  <h1 id="litheader">Update Member Details</h1>
	  <div class="inset">
	    <p>
	      <input type="text" name="id" placeholder="ID">
	    </p>
	    <p>
	      <input type="text" name="name" placeholder="Name" onblur="return validateName()">
	    </p>
	    <p>
	      <input type="text" name="location" placeholder="Location">
	    </p>
	    <p>
	      <input type="text" name="email" placeholder="Email" onblur="return validateEmail()">
	    </p>
	    <p>
	      <input type="text" name="total" placeholder="Total Survey Taken">
	    </p>
	  </div>
