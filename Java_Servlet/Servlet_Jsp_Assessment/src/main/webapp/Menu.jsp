    ...
    <ul>
      <li>
        <button>
          ...
          <a href="InsertMember.jsp" target="frame3">Insert</a>
        </button>
      </li>
      <li>
        <button>
          ...
          <a href="UpdateMember.jsp" target="frame3">Update</a>
        </button>
      </li>
      <li>
        <button>
          ...
          <a href="ViewAll.jsp" target="frame3">View All</a>
        </button>
      </li>
      <li>
        <button>
          ...
          <a href="FindMember.jsp" target="frame3">Find Member</a>
        </button>
      </li>
      <li>
        <button>
          ...
          <a href="DeleteMember.jsp" target="frame3">Delete</a>
        </button>
      </li>
    </ul>
  </nav>
