...
<% 
	...
	out.println("<table class=container><thead><tr><th><h1>Student ID</h1></th><th><h1>Name</h1></th><th><h1>City</h1></th><th><h1>Mobile Number</h1></th><th><h1>D</h1></th></tr></thead>");
	//	while(rs.next()) {
	...
	for(Student stu : alstu) {
		out.println("<tr><td>"+stu.getStuid()+"</td><td>"+stu.getName()+"</td><td>"+stu.getCity()+"</td><td> "+stu.getMobile()+"</td><td> "+stu.getMobile()+"</td></tr>");
		count++;
	}
	out.println("</table>");
	if(count<1) {
