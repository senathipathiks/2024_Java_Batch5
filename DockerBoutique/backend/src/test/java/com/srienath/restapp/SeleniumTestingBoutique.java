...
//	    driver.findElement(By.name("boutiqueName")).sendKeys("CabinWoods");
//	    driver.findElement(By.name("email")).click();
//	    driver.findElement(By.name("email")).sendKeys("CabinWoods@gmail.com");
//	    driver.findElement(By.name("address")).click();
//	    driver.findElement(By.name("address")).sendKeys("Kaalavasal, Madurai");
//	    driver.findElement(By.xpath("//input[@name=\'description\']")).click();
//	    driver.findElement(By.xpath("//input[@name=\'description\']")).sendKeys("CabinWoods is Fashion.");
...
//	    driver.manage().window().setSize(new Dimension(1528, 816));
//	    driver.findElement(By.xpath("//table[@id=\'addemp\']/tbody/tr[1]/td[6]/a")).click();
//	    driver.findElement(By.name("email")).click();
//	    driver.findElement(By.name("email")).sendKeys("CabinWoods345@gmail.com");
//	    driver.findElement(By.name("boutiqueName")).click();
//	    driver.findElement(By.name("boutiqueName")).clear();	    
//	    driver.findElement(By.name("boutiqueName")).sendKeys("WoodLands");
//	    driver.findElement(By.name("email")).click();
//	    driver.findElement(By.name("email")).clear();
//	    driver.findElement(By.name("email")).sendKeys("WoodLands@gmail.com");
//	    driver.findElement(By.name("address")).click();
//	    driver.findElement(By.name("address")).clear();
//	    driver.findElement(By.name("address")).sendKeys("Anna Nagar, Madurai");
//	    driver.findElement(By.xpath("//input[@name=\'description\']")).click();
//	    driver.findElement(By.xpath("//input[@name=\'description\']")).clear();
//	    driver.findElement(By.xpath("//input[@name=\'description\']")).sendKeys("WoodLands brings luxury far cheaper.");
//	    driver.findElement(By.cssSelector(".btn")).click();	    
//
//	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
//		wait.until(ExpectedConditions.alertIsPresent());
