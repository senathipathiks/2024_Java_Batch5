...
public class Technical extends Trainer {
	...
	public Technical(int trainerid, String trainername, String experience) {
		super(trainerid, trainername, experience);
		// TODO Auto-generated constructor stub
	}
	public Technical(int trainerid, String trainername, String experience, String qualification, String specification) {
		super(trainerid, trainername, experience);
