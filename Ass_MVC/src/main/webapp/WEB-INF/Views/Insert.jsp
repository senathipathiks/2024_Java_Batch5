...
<tr>
<center><td><h2>Enter Name  : <input type="text" name="ename" class="in" required><br></td></tr></h2>
<!-- <tr>
<td><h2>Enter City : <input type="text" name="scity" class ="in" required></td><br><br></tr></h2>-->

<td><h2>Enter Dept : <input type="text" name="edept" class ="in" required></td><br><br></tr></h2>
