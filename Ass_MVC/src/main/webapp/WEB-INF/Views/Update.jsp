			...
			<div>
				<h2>
					<table border="1" align="center" class="container">
						<tr>
							<th><h2>ID:</th>
							<td><input type="hidden" name="eid" placeholder="Student ID"
								value=${ Empl.getEid()}></td>
								</h2>
						</tr>
						...
						<tr>
							...
							<td><input type="text" name="ename"
								placeholder="Student name" value=${ Empl.getEname()}></td>
							</h2>
						</tr>
						...
						<tr>
							...
							<td><input type="text" name="edept"
								placeholder="Student city" value=${ Empl.getScity()}></td>
								</h2>
						</tr>
