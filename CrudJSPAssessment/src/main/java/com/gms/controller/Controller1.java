...
import com.gms.bean.Employee;
import com.gms.dao.GMSDAO;
...
public class Controller1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GMSDAO dao=new GMSDAO();
		int n=0;
		if(action.equals("Insert"))
		{
			int empid=Integer.parseInt(request.getParameter("id"));
			String empname=request.getParameter("ename");
			String empdeisg=request.getParameter("desg");
			String empdept=request.getParameter("dept");
			Employee e=new Employee(empid,empname,empdeisg,empdept);
			try {
				n=dao.doInsert(e);
			}
