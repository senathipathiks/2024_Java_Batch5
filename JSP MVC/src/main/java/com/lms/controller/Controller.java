...
public class Controller extends HttpServlet  {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(name.equals("Find"))
		{
			...
			Employee e1=new Employee(Integer.parseInt(request.getParameter("id")),request.getParameter("name"),request.getParameter("des"),request.getParameter("dept"));
...
//			RequestDispatcher rd=request.getRequestDispatcher("ViewSuccess.jsp");
			RequestDispatcher rd=request.getRequestDispatcher("Viewjstl.jsp");
