			...
			<div>
				<h2>
					<table border="1" align="center" class="container">
						<tr>
							<th><h2>ID:</th>
							<td><input type="hidden" name="aid" placeholder="Alumni ID"
								value=${ Alum.getAid()}></td>
								</h2>
						</tr>
						...
						<tr>
							...
							<td><input type="text" name="aname"
								placeholder="Alumni name" value=${ Alum.getAname()}></td>
							</h2>
						</tr>

						<tr>
							<th><h2>Enter batch:</th>
							<td><input type="text" name="abatch"
								placeholder="Batch" value=${ Alum.getAbatch()}></td>
								</h2>
						</tr>
						
						<tr>
							<th><h2>Enter dept:</th>
							<td><input type="text" name="adept"
								placeholder="Dept" value=${ Alum.getAdept()}></td>
								</h2>
						</tr>
